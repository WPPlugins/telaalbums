...
if (!function_exists("telaalbums_embedAlbumContents")) {
function telaalbums_embedAlbumContents($ALBUM,$IN_POST = null,$TAG,$overrides_array) {
require (dirname(__FILE__) . '/includes/telaalbums_options.php');

if (isset($overrides_array["album"])) { 

echo "Found!!!";

$album = $overrides_array["album"];
#----------------------------------------------------------------------------
# CONFIGURATION
#----------------------------------------------------------------------------
