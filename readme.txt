...
Check out [the demo](https://telaaedifex.com/albums/main-demo/) to see the code in action.
...
See [the wiki entry on it](https://telaaedifex.com/utils/support/kb/faq.php?id=13).
